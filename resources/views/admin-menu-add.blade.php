        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="w-full">
                <div class="flex shadow-lg rounded-2xl p-4 bg-white w-full">
                    <form method="POST" class="w-full md:w-1/2" action="{{ route('adminAddMenuStore') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="relative pb-4">
                            ...
                            <input type="text" id="required-menu-name" name="name" placeholder="Sup Konro" class="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-gray-50 focus:bg-white transition ease-in-out duration-200 text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-sky-600 focus:border-transparent"/>
                        </div>
                        <div class="relative pb-4">                            
                            ...
                            <textarea id="required-menu-description" placeholder="Enter your description" name="description" rows="5" cols="40" class="border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-gray-50 focus:bg-white transition ease-in-out duration-200 text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-sky-600 focus:border-transparent"></textarea>
                        </div>
                        <div class="relative pb-4">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" id="required-menu-price" placeholder="0,00" name="price" class="focus:ring-sky-500 border-l border-b border-t border-transparent bg-gray-50 text-gray-700 placeholder-gray-400 focus:bg-white transition ease-in-out duration-200 py-2 px-4 focus:border-sky-500 block w-full pl-9 sm:text-sm rounded-md"/>
                            </div>
                        </div>
                        <div class="relative pb-4">
